...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'users_userprofile', 'email', self.gf('django.db.models.fields.EmailField')(max_length=254, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.email'
        db.alter_column(u'users_userprofile', 'email', self.gf('django.db.models.fields.EmailField')(max_length=254))
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'userref': ('django.db.models.fields.CharField', [], {'default': "'d2b206d448c6449ba15f6d3d38e1a8e0'", 'unique': 'True', 'max_length': '100'})
        }
    }
