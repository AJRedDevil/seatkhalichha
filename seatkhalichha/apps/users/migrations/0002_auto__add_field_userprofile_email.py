...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'users_userprofile_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'users.userprofile'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'users_userprofile_user_permissions'))
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'userref': ('django.db.models.fields.CharField', [], {'default': "'92fbc71270044092a99f7825371672dc'", 'unique': 'True', 'max_length': '100'})
        }
    }
