...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Adding field 'UserProfile.displayname'
        db.add_column(u'users_userprofile', 'displayname',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, unique=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'userref': ('django.db.models.fields.CharField', [], {'default': "'4beece99b40d42f99d9427c955e61aa5'", 'unique': 'True', 'max_length': '100'})
        }
    }
