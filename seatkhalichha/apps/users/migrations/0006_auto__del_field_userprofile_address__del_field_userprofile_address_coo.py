...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'users_userprofile', 'address')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'users_userprofile', 'address',
                      self.gf('jsonfield.fields.JSONField')(default={'city': 'Kathmandu', 'streetaddress': 'Tripureshwore'}, max_length=9999, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.address_coordinates'
        db.add_column(u'users_userprofile', 'address_coordinates',
                      self.gf('django.contrib.gis.db.models.fields.PointField')(default='', null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'userref': ('django.db.models.fields.CharField', [], {'default': "'b93c0a4b0954472e979c45fe199978ec'", 'unique': 'True', 'max_length': '100'})
        }
    }
